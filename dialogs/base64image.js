/*
Based on the base64image plugin (https://github.com/nmmf/base64image) enhanced with additionnal features
*/
CKEDITOR.dialog.add("base64imageDialog", function (editor) {
  ...
  return {
    ...
    onOk: function () {
      ...
      var newImg = selectedImg || editor.document.createElement("img");
